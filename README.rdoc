...
git, gh (GitHub CLI), asdf (standard git install, *not* homebrew), pyenv, {gpg}[https://gpgtools.org/]


== Installation

  git clone git@github.com:pboling/dotfiles.git ~/Documents/src/dotfiles
...
For pkg-config to find icu4c (icu-uc / icu-i18n) you may need to set:
  export PKG_CONFIG_PATH=$(brew --prefix icu4c)/lib/pkgconfig 

Putting the pkg-config bits together gives:
  export PKG_CONFIG_PATH="/opt/homebrew/bin/pkg-config:$(brew --prefix icu4c)/lib/pkgconfig:$(brew --prefix curl)/lib/pkgconfig:$(brew --prefix zlib)/lib/pkgconfig"

And this allows installation of, for example, postgres, e.g.:
